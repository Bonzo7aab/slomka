...
const Hero = () => {
    return (
        <section id="home" className="relative w-full mt-24 lg:mt-0">
            ...
            <div className='absolute flex p-2 font-bold tracking-wider transform -translate-x-1/2 -translate-y-1/2 md:p-8 w-max text-cp0-500 top-1/2 left-1/2'>
                <div className="text-3xl tracking-widest border-2 border-red-500">FILM</div>
                <div className="flex flex-col border-2 border-cp0-600">
                    <span><span className="text-3xl">S</span> - starannie</span>
                    <span><span className="text-3xl">M</span> - merytorycznie</span>
                    <span><span className="text-3xl">K</span> - kompetentnie</span>
                </div>
