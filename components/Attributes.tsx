        ...
        <section className="max-w-6xl px-8 mx-auto md:py-10 sm:px-6 lg:px-8 lg:py-14">
            <div className="flex flex-col gap-8 lg:grid lg:grid-cols-12 lg:gap-16 lg:items-center">
                <div className="mt-5 sm:mt-10 lg:mt-0 lg:col-span-5">
                    <div className="space-y-6 text-lg leading-relaxed tracking-wide text-gray-400 sm:space-y-8">
                ...
                <div className="relative flex self-center lg:col-span-7">
                    <div className="flex flex-wrap h-[432px]">
